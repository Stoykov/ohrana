...
trait OhranaPermission
{
    ...
    */
    ...
    public function getPermissions()
    {
        ...
        $permissions = \Cache::remember(
            'ohrana.getPermissionsById_'.$this->id,
            config('ohrana.cacheMinutes'),
            function () {
     ...
     * @return bool
     */
    public function hasPermisson($action, $operator = null)
    {
    ...
    */
    ...
    {
        // First check for 'ALL' permission
        // Then check for namespace permission
        // Then check for controller permission
        // Lastly check for method permission
